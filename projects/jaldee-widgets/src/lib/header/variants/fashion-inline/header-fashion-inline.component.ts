...
@Component({
  selector: 'app-header-fashion-inline',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './header-fashion-inline.component.html',
  styleUrls: ['./header-fashion-inline.component.scss']
})
export class HeaderFashionInlineComponent implements OnChanges {
